function [d,angleError,angleError2,x,time,hRWA,p,p2,torque] =NadirFunction(x,d,p,p2,time)
%% Nadir Function for a CubeSat orbit and attitude dynamical model.
%
% Calculates the torque that the reaction wheels have to do to point the 
% desired axis to the nadie and stabilize the other two axsis aligning one
