function [xDot,dist,power] = RHSCubeSat2( x, t, d,bField,w_read )
...
if ~isempty(d.kWheels)
  ...
  hT     = d.inertia*w + d.inertiaRWA*(c + w_read);
  wDot   = d.inertia\(tTotal - d.tRWA + Cross(w_read,hT));
