...
OE.Omega_deg = str2double(line2(18:26));    
...
OE.M_deg = str2double(line2(45:54));   
line2(44:55)

% [km] semi major axis
a=(str2double(line2(55:65))*2*pi/86400)^2;
OE.a_km = ( mu/a )^(1/3); 
...
OE.n_orbits_per_day = str2double(line2(55:65)); 
